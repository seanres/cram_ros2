...
bool move_to_pose(moveit::planning_interface::MoveGroupInterface &move_group_interface,
                  ...
                  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr script_pub)
{
    ...
    if (success)
    {
        RCLCPP_INFO(logger, "Printing Now!");

        // Publish true here!!!!
        auto msg = std::make_unique<std_msgs::msg::String>();
        msg->data = "def my_prog():\n\n  set_digital_out(1, True)\n\nend";
        script_pub->publish(std::move(msg));
...
int main(int argc, char *argv[])
{
    ...
    auto script_pub = node->create_publisher<std_msgs::msg::String>("/urscript_interface/script_command", 10); // Create the publisher
    ...
    success = move_to_pose(move_group_interface, target_pose, logger, script_pub);
    if (!success)
        return 1;
