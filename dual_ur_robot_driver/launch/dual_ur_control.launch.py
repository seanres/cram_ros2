...
def generate_launch_description():
    ...
    arm_0_use_fake_hardware = LaunchConfiguration('arm_0_use_fake_hardware')
    arm_0_launch_rviz = LaunchConfiguration('arm_0_launch_rviz')
    ...
    arm_1_use_fake_hardware = LaunchConfiguration('arm_1_use_fake_hardware')
    arm_1_launch_rviz = LaunchConfiguration('arm_1_launch_rviz')
    ...
    arm_0_use_fake_hardware_arg = DeclareLaunchArgument(
            "arm_0_use_fake_hardware",
            default_value="true",
    )
    arm_0_launch_rviz_arg = DeclareLaunchArgument(
            "arm_0_launch_rviz",
            default_value="false",
    )
    ...
    arm_1_use_fake_hardware_arg = DeclareLaunchArgument(
            "arm_1_use_fake_hardware",
            default_value="true",
    )
    arm_1_launch_rviz_arg = DeclareLaunchArgument(
            "arm_1_launch_rviz",
            default_value="false",
    )
    ...
    arm_0 = IncludeLaunchDescription(
        ...
        launch_arguments={'ur_type': ur_type,
                          ...
                          'use_fake_hardware': arm_0_use_fake_hardware,
                          'launch_rviz': arm_0_launch_rviz,
    ...
    arm_1 = IncludeLaunchDescription(
        ...
        launch_arguments={'ur_type': ur_type,
                          ...
                          'use_fake_hardware': arm_1_use_fake_hardware,
                          'launch_rviz': arm_1_launch_rviz,
    ...
    return LaunchDescription([
        ...
        arm_0_tf_prefix_arg,
        arm_0_use_fake_hardware_arg,
        arm_0_launch_rviz_arg,
        ...
        arm_1_tf_prefix_arg,
        arm_1_use_fake_hardware_arg,
        arm_1_launch_rviz_arg,
